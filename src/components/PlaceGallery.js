...
export default function PlaceGallery({ place }) {
  ...
  return (
    <div className="relative">
        ...
        <div>
          {place.photos?.[0] && (
            <img
              ...
              src={`https://stayspot-backend-cd17.onrender.com/uploads/${place.photos[0]}`}
        ...
        <div className="grid">
          {place.photos?.[1] && (
            <img
              ...
              src={`https://stayspot-backend-cd17.onrender.com/uploads/${place.photos[1]}`}
          ...
          {place.photos?.[2] && (
            <div className="overflow-hidden">
              <img
                ...
                src={`https://stayspot-backend-cd17.onrender.com/uploads/${place.photos[2]}`}
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className="flex gap-1 absolute bottom-2 right-2 py-2 px-2 sm:px-4 bg-white rounded-2xl shadow-md shadow-gray-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
